...
Route Entry
  -> Page Orchestrator
    ...
    -> View Model Builder
      -> Domain Components
        -> Document Canvas / Baseline Panels / Turn Logs / Workorder Preview
```
...
| `P3DesignDocumentCanvas` | 软件设计说明 A4 正文渲染 |
| `P3DesignCliPanel` | 自然语言设计轮次输入和日志 |
| `P3DesignBaselineRail` | 设计基线摘要、检查结果和工单投影 |
| `P3DesignViewModel` | 把后端 DTO 转成页面展示对象 |
