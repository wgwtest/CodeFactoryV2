...
| `Requirement Analysis Orchestrator Lab` | 容易被理解为聊天功能 | `Requirement Analysis Orchestrator Lab` |
...
| `apps/api/app/requirement_analysis/spec_tree_service.py` | 需求规格完成度树初始化、查找、关闭和父节点状态刷新 |
...
| `apps/api/app/requirement_analysis/question_bank.py` | XG 条款基础问题库 |
