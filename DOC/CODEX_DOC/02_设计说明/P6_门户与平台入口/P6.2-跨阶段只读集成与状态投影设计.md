...
- `DOC/CODEX_DOC/04_研发文档/01_数据规范/01-P1-P5到P6状态输出接口规范.md`
...
`P1 ~ P5 -> P6` 的跨阶段共享约束固定以 `DOC/CODEX_DOC/04_研发文档/01_数据规范/01-P1-P5到P6状态输出接口规范.md` 为准。
...
后续若 `P1 ~ P5` 任一阶段补充真实接口，应以该规范作为直接事实源，再回写本文件中的平台消费说明。
...
- 跨阶段共享规范：`DOC/CODEX_DOC/04_研发文档/01_数据规范/01-P1-P5到P6状态输出接口规范.md`
