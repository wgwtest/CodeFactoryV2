...
DOC/CODEX_DOC/06_测试文档/03_机测记录/2026-05测试/260510-1317-P2-组织器多轮整改6轮总体测试分析报告.md
DOC/CODEX_DOC/06_测试文档/03_机测记录/2026-05测试/260510-1911-P2-组织器多轮整改交互证据附录/README.md
```

如果要继续生成 P2 组织器整改测试的可视化样例，还需要读取 6 轮交互证据附件：

```text
DOC/CODEX_DOC/06_测试文档/03_机测记录/2026-05测试/260510-1911-P2-组织器多轮整改交互证据附录/
```
