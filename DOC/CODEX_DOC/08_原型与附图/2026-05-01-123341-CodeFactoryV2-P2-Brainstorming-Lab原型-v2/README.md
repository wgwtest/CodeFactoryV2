...
| `P2-需求分析系统设计-260430-0117-需求规格编写系统原型设计.md` | 正式工作台仍保持问答 / 表单 / 标准正文结构，不被 Lab 替代 |
| `P2-需求分析系统设计-260430-2211-XX-P1-Sim上游知识服务模拟器设计.md` | Lab 可以使用假知识包，但不关心知识来源是真实 P1 还是 Sim |
