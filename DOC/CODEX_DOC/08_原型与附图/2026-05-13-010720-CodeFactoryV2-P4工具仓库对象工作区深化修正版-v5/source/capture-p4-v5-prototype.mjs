...
const shots = [
  ["demand-sheets", "01-1920x1080-P4需求工单列表与进入工单.png"],
  ["demand-tool-config", "02-1920x1080-P4单工具需求匹配验证配置.png"],
  ["asset-list", "03-1920x1080-P4工具资产大页资源列表子Tab.png"],
  ["asset-detail", "04-1920x1080-P4成品工具资产使用与演进属性.png"],
  ["evolution-actions", "05-1920x1080-P4演进配置与运行轮次.png"],
...
for (const [state, filename] of shots) {
  ...
  await page.locator("#p4-v5-stage").waitFor({ state: "visible", timeout: 15000 });
