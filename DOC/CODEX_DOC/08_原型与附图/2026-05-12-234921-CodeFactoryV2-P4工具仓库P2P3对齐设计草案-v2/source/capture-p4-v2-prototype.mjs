...
const source = `file://${path.join(__dirname, "p4-p2p3-aligned-prototype.html")}`;

const shots = [
  ["demand", "01-1920x1080-P4需求工序工作台.png"],
  ["asset", "02-1920x1080-P4工具资产正面产物台.png"],
  ["runtime", "03-1920x1080-P4运行与自演进观察台.png"],
];
...
for (const [state, filename] of shots) {
  ...
  await page.locator("#p4-v2-board").waitFor({ state: "visible", timeout: 15000 });
