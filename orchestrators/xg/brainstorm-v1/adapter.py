...
class LocalXGOrchestratorPluginAdapter:
    ...
    def run(self, request: OrchestratorRunRequest) -> OrchestratorRunResult:
        ...
        return OrchestratorRunResult(
            ...
            state_output={
                ...
                "decision_state_delta": dict(turn_result.turn.get("decision_state_delta") or {}),
                "decision_state_change_summary": dict(turn_result.turn.get("decision_state_change_summary") or {}),
                "decision_state_document": dict(turn_result.turn.get("decision_state_document") or {}),
                "spec_tree_update": {},
    ...
    def _runtime(self):
        ...
        return self.runtime_host.build_policy_interpreted_runtime()
