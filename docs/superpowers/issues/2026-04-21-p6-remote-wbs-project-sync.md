...
- `P6`
  ...
  - 总体设计：`DOC/CODEX_DOC/02_设计说明/10-P6-门户与平台入口设计.md`
- `P6.1`
  - 专项设计：`DOC/CODEX_DOC/02_设计说明/11-P6.1-首屏观察门户设计.md`
- `P6.2`
  - 专项设计：`DOC/CODEX_DOC/02_设计说明/12-P6.2-跨阶段只读集成与状态投影设计.md`
- `P6.3`
  - 专项设计：`DOC/CODEX_DOC/02_设计说明/13-P6.3-设计语言与前端展示基线设计.md`
- `P6.4`
  - 专项设计：`DOC/CODEX_DOC/02_设计说明/14-P6.4-前端展示工具化实验场设计.md`
