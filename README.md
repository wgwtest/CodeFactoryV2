...
## Local commands
- `.venv/bin/python -m pytest apps/api/tests/test_health.py -q` – run the health-check test (TDD step).
- `.venv/bin/python -m pytest apps/api/tests -q` – execute the API test suite.
