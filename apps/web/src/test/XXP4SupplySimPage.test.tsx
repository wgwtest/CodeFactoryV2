...
test("renders the xx-p4-supply-sim page, creates a simulated supply snapshot, and returns to P5 workspace", async () => {
  render(
  ...
  fireEvent.click(screen.getByRole("button", { name: "生成供给输出并返回 P5" }));
  ...
  expect(getMock).toHaveBeenCalledWith("/software-build/orders");
});
